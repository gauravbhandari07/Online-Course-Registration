...
<link href="./assets/css/login.css" crossorigin="anonymous" rel="stylesheet">
<link
      rel="icon"
      type="image/png"
      sizes="16x16"
      href="./assets/images/login-page-img.png"
/>
  </head>
  ...
  <body style="background-color:#edeef5">
          ...
          <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
            <form method="POST">
              <div class="form-outline mb-4">
                <h3 style="color:#4e73df">Admin Panel</h3>
              </div>
              <!-- Email input -->
              <div class="form-outline mb-4">
              ...
              <!-- Submit button -->
              <button type="submit"name="submit" style="float:right;background-color:blue" class="btn btn-outline-primary btn-lg btn-block">Sign in</button>
            </form>
...
<button type="submit" class="btn  btn-lg btn-block" style="background-color:#B0B8EB"onclick="gotoReg()">Register Course (Student)</button>
</div>
        </div>
      </div>
    </section>
