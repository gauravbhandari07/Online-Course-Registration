      ...
      <header class="topbar" data-navbarbg="skin6">
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
          <div class="navbar-header" data-logobg="skin6">
            ...
            <!-- Logo -->
            <!-- ============================================================== -->
            <a class="navbar-brand" href="allStudent.php">
              <!-- Logo icon -->
              <b class="logo-icon">
            ...
            <ul id="sidebarnav">
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">All Student</span></a
                >
              </li>
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Web Dev</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">App Dev</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Design</span></a
                >
              </li>
            </ul>
          </nav>
